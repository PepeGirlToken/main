...
let addr;
const sttaddr = "0xbaF59e4a9a9080aFa2668bE6C314324ad4Dc77A3";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xbaF59e4a9a9080aFa2668bE6C314324ad4Dc77A3";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://pepegirl.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xbaF59e4a9a9080aFa2668bE6C314324ad4Dc77A3',
                    'symbol': 'PEPEG',
                    'decimals': '18',
                    'image': 'https://pepegirl.org/img/logo.png',
                },
            },
